...
const Quize = () => {
  return (
    <div className='w-[640px] m-auto  bg-white text-[#262626] flex flex-col rounded-[10px] py-[40px] px-[50px]'>
        ...
        <h2 className='text-[25px] font-semibold '>1. Which Device is required for the Internet connection?</h2>
        <ul className='mt-5'>
        ...
        <button className='px-6 py-1 bg-[#553f9a] rounded-[8px] m-auto w-[300px] h-[60px] text-[#fff] font-semibold cursor-pointer text-[25px]'>Next</button>
